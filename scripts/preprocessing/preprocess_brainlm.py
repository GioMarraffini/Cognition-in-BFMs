...
Examples:
    ...
    # Input/output
    parser.add_argument("--input-dir", "-i", help="Directory containing .nii.gz fMRI files")
    parser.add_argument(
        "--output-dir",
        "-o",
    ...
    parser.add_argument(
        "--atlas", default="preprocessing/atlases/A424+2mm.nii.gz", help="Path to A424 atlas file"
    )
    parser.add_argument(
        "--timepoints",
        "-t",
    ...
    parser.add_argument(
        "--population-stats", help="Path to .npz file with global_median and global_iqr arrays"
    )
    parser.add_argument(
        "--compute-stats",
        metavar="DIR",
