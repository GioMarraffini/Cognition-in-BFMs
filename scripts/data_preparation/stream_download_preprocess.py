...
def stream_download_preprocess(
    ...
    Args:
        ...
        n_train: Number of training subjects to process
        n_test: Number of test subjects to process
        skip_existing: Skip already processed subjects
        global_stats_file: Path to global statistics pickle file
        n_workers: Number of parallel workers (1=sequential)
    """
    print("=" * 70)
    print("STREAMING DOWNLOAD + PREPROCESS PIPELINE (BrainLM-style)")
    print("=" * 70)
