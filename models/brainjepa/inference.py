...
def load_model(
    ...
    if checkpoint_path is None:
        checkpoint_path = Path(__file__).parent.parent / "pretrained_models" / "brainjepa" / "jepa-ep300.pth.tar"
    else:
...
def extract_all_features_batch(
    ...
    features = {}
    iterator = tqdm(npy_files.items(), desc="Extracting Brain-JEPA features") if verbose else npy_files.items()
