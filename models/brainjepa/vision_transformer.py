...
# Brain-JEPA: https://github.com/Eric-LRL/Brain-JEPA
# --------------------------------------------------------
...
# Local imports - trunc_normal_ and apply_masks
...
# Try to import flash_attn, fall back to normal attention if not available
try:
...
class GradTs_2dPE(nn.Module):
    def __init__(self, in_chan, embed_dim, grid_size, add_w=False, cls_token=False) -> None:
        ...
        self.emb_h = nn.Parameter(
            torch.zeros(grid_size[0] * grid_size[1], embed_dim // 2), requires_grad=False
        )
